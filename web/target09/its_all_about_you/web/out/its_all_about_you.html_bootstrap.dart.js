...
$$.ListView = {"": "SubListView;_list,_start,_end",
  $index: function(index) {
    ...
    if (typeof start !== "number")
      return this.$$index$bailout1(2, index, start);
    end = this._absoluteIndex$1(this._end);
    if (typeof end !== "number")
      return this.$$index$bailout1(3, index, start, end);
    $length = end - start;
    ...
    t3 = start + index;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout1(4, index, start, 0, t1);
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
    if (t3 < 0 || t3 >= t1.length)
      throw $.ioore(t3);
  ...
  $$index$bailout1: function(state0, index, start, end, t1) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$.ReversedListView = {"": "SubListView;_list,_start,_end",
  $index: function(index) {
    ...
    if (typeof end !== "number")
      return this.$$index$bailout0(3, index, start, end);
    if (typeof start !== "number")
      return this.$$index$bailout0(2, index, start);
    $length = end - start;
    if (index < 0 || index >= $length)
      throw $.$$throw($.RangeError$range(index, 0, $length));
    t1 = this._list;
    t3 = end - index - 1;
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout0(4, index, 0, end, t1, $.CONSTANT3);
    if (t3 !== (t3 | 0))
      throw $.iae(t3);
    if (t3 < 0 || t3 >= t1.length)
      throw $.ioore(t3);
  ...
  $$index$bailout0: function(state0, index, start, end, t1, t3) {
    switch (state0) {
      case 0:
      case 1:
        state0 = 0;
...
$$._ListWatcher = {"": "_Watcher;debugName,_getter,_callback,_lastValue",
  _compare$1: function(currentValue) {
    ...
    if ($.$$eq($.length(this._lastValue), currentValue.length) !== true)
      return true;
    for (i = 0; $.CONSTANT2.$lt(i, $.length(this._lastValue)); ++i) {
...
$$.LinkedListIterator = {"": "Object;_copy,_liblib2$_list>,_pos",
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (t1 < t4) {
        ...
        if (t1 < 0 || t1 >= t4)
          throw $.ioore(t1);
        t2 = $.$$eq(t3[t1].get$_liblib2$_list(), this._liblib2$_list) !== true;
        t1 = t2;
      } else
        t1 = false;
    } while (t1);
    ...
    if (typeof t1 !== "number")
      return this.moveNext$0$bailout3(3, t1);
    return t1 < t3;
  },
            ...
            switch (state0) {
              ...
              case 2:
                ...
                if ($.$$lt(t1, this._copy.length) === true) {
                  ...
                  if (t2 < 0 || t2 >= t1.length)
                    throw $.ioore(t2);
                  t3 = $.$$eq(t1[t2].get$_liblib2$_list(), this._liblib2$_list) !== true;
                  t1 = t3;
                } else
                  t1 = false;
                if (!t1)
  ...
  LinkedListIterator$1: function(_list) {
    var node, i, t1, i0;
    this._copy = $.List_List$fixedLength($.length(this._liblib2$_list), null);
...
$$.init_autogenerated_anon0 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.favoritenumber = this.box_0.__e0_0.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon5 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.valueofpi = this.box_0.__e3_3.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon10 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.horrorscope = this.box_0.__e6_4.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon15 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.favone = this.box_0.__e9_5.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon19 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.favtwo = this.box_0.__e10_1.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon21 = {"": "Closure;box_0",
  call$1: function(e) {
    this.box_0.__e10_1.set$value(e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon23 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.favthree = this.box_0.__e11_2.get$value();
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon25 = {"": "Closure;box_0",
  call$1: function(e) {
    this.box_0.__e11_2.set$value(e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon28 = {"": "Closure;",
  call$1: function($$event) {
    $.showJSON();
  },
  $isFunction: true
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $._FutureImpl$immediate($.CONSTANT11);
  completer = $._CompleterImpl$();
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    if ($._Device_isOpera() !== true && $.contains0($._Device_userAgent(), "MSIE", 0) === true && $.CONSTANT5.containsKey$1(tag) === true)
...
$.showJSON = function() {
  var favnum, pi, choco, favoritethings, formdata;
  favnum = $.int_parse($.favoritenumber, null, null);
  pi = $.double_parse($.valueofpi, null);
  choco = document.query$1("#true").get$checked() === true && true;
  favoritethings = [$.favone, $.favtwo, $.favthree];
  formdata = $.makeLiteralMap(["favoritenumber", favnum, "valueofpi", pi, "chocolate", choco, "horrorscope", $.horrorscope, "favoritethings", favoritethings]);
  $.intasjson = $._JsonStringifier_stringify(favnum);
  $.doubleasjson = $._JsonStringifier_stringify(pi);
  $.boolasjson = $._JsonStringifier_stringify(choco);
  $.stringasjson = $._JsonStringifier_stringify($.horrorscope);
  $.listasjson = $._JsonStringifier_stringify(favoritethings);
  $.mapasjson = $._JsonStringifier_stringify(formdata);
};

$.populateFromJSON = function() {
  var jsondata, t1;
  jsondata = $.parse("{ \"favoritenumber\":44,\n  \"valueofpi\":3.141592,\n  \"chocolate\":true,\n  \"horrorscope\":\"virgo\",\n  \"favoritethings\":[\"raindrops\",\n                    \"whiskers\",\n                    \"mittens\"]\n}\n", null);
  t1 = $.getInterceptor$JSStringJSArray(jsondata);
  $.favoritenumber = $.toString(t1.$index(jsondata, "favoritenumber"));
  $.valueofpi = $.toString(t1.$index(jsondata, "valueofpi"));
  $.horrorscope = t1.$index(jsondata, "horrorscope");
  $.favone = $.$$index(t1.$index(jsondata, "favoritethings"), 0);
  $.favtwo = $.$$index(t1.$index(jsondata, "favoritethings"), 1);
  $.favthree = $.$$index(t1.$index(jsondata, "favoritethings"), 2);
  if (t1.$index(jsondata, "chocolate") === true)
    document.query$1("#true").set$checked(true);
  else
    document.query$1("#false").set$checked(true);
};

$.init_autogenerated = function() {
  var t1, _root, __t, __e2, __binding1, __e5, __binding4, __e8, __binding7, __e13, __binding12, __e15, __binding14, __mapasjson, __binding16;
  t1 = {};
  ...
  __t.listen$2(t1.__e0_0.get$onChange(), new $.init_autogenerated_anon());
  __t.listen$2(t1.__e0_0.get$onInput(), new $.init_autogenerated_anon0(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon1(), new $.init_autogenerated_anon2(t1), false);
  __e2 = _root.query$1("#__e-2");
  __binding1 = __t.contentBind$1(new $.init_autogenerated_anon3());
  $.addAll(__e2.get$nodes(), [document.createTextNode(" "), __binding1, document.createTextNode(" ")]);
  t1.__e3_3 = _root.query$1("#__e-3");
  __t.listen$2(t1.__e3_3.get$onChange(), new $.init_autogenerated_anon4());
  __t.listen$2(t1.__e3_3.get$onInput(), new $.init_autogenerated_anon5(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon6(), new $.init_autogenerated_anon7(t1), false);
  __e5 = _root.query$1("#__e-5");
  __binding4 = __t.contentBind$1(new $.init_autogenerated_anon8());
  $.addAll(__e5.get$nodes(), [document.createTextNode(" "), __binding4, document.createTextNode(" ")]);
  t1.__e6_4 = _root.query$1("#__e-6");
  __t.listen$2(t1.__e6_4.get$onChange(), new $.init_autogenerated_anon9());
  __t.listen$2(t1.__e6_4.get$onInput(), new $.init_autogenerated_anon10(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon11(), new $.init_autogenerated_anon12(t1), false);
  __e8 = _root.query$1("#__e-8");
  __binding7 = __t.contentBind$1(new $.init_autogenerated_anon13());
  $.addAll(__e8.get$nodes(), [document.createTextNode(" "), __binding7, document.createTextNode(" ")]);
  t1.__e9_5 = _root.query$1("#__e-9");
  __t.listen$2(t1.__e9_5.get$onChange(), new $.init_autogenerated_anon14());
  __t.listen$2(t1.__e9_5.get$onInput(), new $.init_autogenerated_anon15(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon16(), new $.init_autogenerated_anon17(t1), false);
  t1.__e10_1 = _root.query$1("#__e-10");
  __t.listen$2(t1.__e10_1.get$onChange(), new $.init_autogenerated_anon18());
  __t.listen$2(t1.__e10_1.get$onInput(), new $.init_autogenerated_anon19(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon20(), new $.init_autogenerated_anon21(t1), false);
  t1.__e11_2 = _root.query$1("#__e-11");
  __t.listen$2(t1.__e11_2.get$onChange(), new $.init_autogenerated_anon22());
  __t.listen$2(t1.__e11_2.get$onInput(), new $.init_autogenerated_anon23(t1));
  __t.oneWayBind$3(new $.init_autogenerated_anon24(), new $.init_autogenerated_anon25(t1), false);
  __e13 = _root.query$1("#__e-13");
  __binding12 = __t.contentBind$1(new $.init_autogenerated_anon26());
  $.addAll(__e13.get$nodes(), [document.createTextNode(" "), __binding12, document.createTextNode(" ")]);
  __t.listen$2(_root.query$1("#true").get$onChange(), new $.init_autogenerated_anon27());
  __t.listen$2(_root.query$1("#false").get$onChange(), new $.init_autogenerated_anon28());
  __e15 = _root.query$1("#__e-15");
  __binding14 = __t.contentBind$1(new $.init_autogenerated_anon29());
  $.addAll(__e15.get$nodes(), [document.createTextNode(" "), __binding14, document.createTextNode(" ")]);
  __mapasjson = _root.query$1("#mapasjson");
  __binding16 = __t.contentBind$1(new $.init_autogenerated_anon30());
  $.add(__mapasjson.get$nodes(), __binding16);
  __t.create$0();
  __t.insert$0();
};
...
$._isSafeUri = function(uri) {
  ...
  if (t1.$eq(scheme, "") === true)
    return true;
  return $.CONSTANT0.contains$1($.CONSTANT7, t1.toLowerCase$0(scheme)) === true || "MAILTO" === t1.toUpperCase$0(scheme);
};
...
$.CONSTANT5 = new Isolate.$isolateProperties.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, Isolate.$isolateProperties.CONSTANT12);
...
$.CONSTANT8 = new Isolate.$isolateProperties.EventStreamProvider("input");
...
$.CONSTANT6 = new Isolate.$isolateProperties.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT13);
...
$.$defineNativeClass("Element", {"": "$$dom_children:children~,id>,innerHtml:innerHTML|,$$dom_lastElementChild:lastElementChild~,tagName>",
  get$children: function() {
