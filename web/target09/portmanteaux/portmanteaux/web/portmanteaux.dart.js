...
$$._HashMapImplIterator = {"": "Object;",
  moveNext$0: function() {
    ...
    for (t2 = t1.get$_keys(); newIndex < $length;) {
      if (typeof t2 !== "string" && (typeof t2 !== "object" || t2 === null || t2.constructor !== Array && !t2.$isJavaScriptIndexingBehavior()))
        return this.moveNext$0$bailout(3, $length, t1, t2, newIndex, $.CONSTANT2);
      if (newIndex !== (newIndex | 0))
        throw $.iae(newIndex);
...
$$.JsonParser = {"": "Object;source>,listener>",
  ...
  parseTrue$1: function(position) {
    ...
    if (typeof t3 !== "number")
      return this.parseTrue$1$bailout(3, position, t2, t1, $.CONSTANT2, t3);
    if (t3 === 114) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseTrue$1$bailout(4, position, t2, t1, $.CONSTANT2, t3);
      if (t3 === 117) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseTrue$1$bailout(5, position, 0, t1, $.CONSTANT2);
        t3 = !(t1 === 101);
        t1 = t3;
      } else
        t1 = true;
  ...
  parseFalse$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseFalse$1$bailout(3, position, t1, t2, $.CONSTANT2, t3);
    if (t3 === 97) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseFalse$1$bailout(4, position, t1, t2, $.CONSTANT2, t3);
      if (t3 === 108) {
        t3 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t3 !== "number")
          return this.parseFalse$1$bailout(5, position, t1, t2, $.CONSTANT2, t3);
        if (t3 === 115) {
          t1 = t2.charCodeAt$1(t1, position + 4);
          if (typeof t1 !== "number")
            return this.parseFalse$1$bailout(6, position, t1, 0, $.CONSTANT2);
          t3 = !(t1 === 101);
          t1 = t3;
        } else
          t1 = true;
  ...
  parseNull$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseNull$1$bailout(3, position, t1, t2, $.CONSTANT2, t3);
    if (t3 === 117) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseNull$1$bailout(4, position, t1, t2, $.CONSTANT2, t3);
      if (t3 === 108) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseNull$1$bailout(5, position, t1, 0, $.CONSTANT2);
        t3 = !(t1 === 108);
        t1 = t3;
      } else
        t1 = true;
  ...
  parseNumber$2: function($char, position) {
    ...
    if ($char === 101 || $char === 69) {
      ...
      if (typeof $char !== "number")
        return this.parseNumber$2$bailout(7, $char, position, $.CONSTANT2, t2, $length, 0, t3, t1);
      if ($char === 43 || $char === 45) {
        ++position;
        if (position === $length)
          this.fail$2(position, "Missing expected digit");
...
$.Primitives_parseDouble = function(source, handleError) {
  ...
  if ($.CONSTANT2.get$isNaN(result) === true && $.$$eq(source, "NaN") !== true)
    return handleError.call$1(source);
  return result;
};
...
$.requestComplete = function(request) {
  var portmanteaux, i, t1, t2, t3;
  if ($.$$eq(request.get$status(), 200) === true) {
    portmanteaux = $.parse(request.get$responseText(), null);
...
$.requestComplete$bailout = function(state0, portmanteaux) {
  switch (state0) {
    case 0:
    case 1:
      var t1, i, t2, t3, t4;
      if (state0 === 1 || state0 === 0 && $.$$eq(request.get$status(), 200) === true)
        switch (state0) {
          case 0:
            portmanteaux = $.parse(request.get$responseText(), null);
          case 1:
...
$.CONSTANT = new Isolate.$isolateProperties.EventStreamProvider("loadend");
