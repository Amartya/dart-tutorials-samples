    ...
    switch (state0) {
      ...
      case 2:
        ...
        if (t2 == null)
          ...
          actualParameters = $.toString(t1.sb_0);
          t1.sb_0 = $.JsStringBuffer$("");
          for (t3 = $.getInterceptor$JSStringJSArray(t2), i = 0; $.CONSTANT4.$lt(i, t3.get$length(t2)); ++i) {
            if (i > 0)
              $.add(t1.sb_0, ", ");
  ...
  _deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      ...
      case 3:
        var id, i;
        state0 = 0;
        for (t1 = $.getInterceptor$JSStringJSArray(values), i = 0; $.CONSTANT4.$lt(i, len); ++i)
...
$$.main_anon = {"": "Closure;",
  call$1: function(e) {
    return $.clear($.toDoList.get$children());
  }
};
...
$$.addToDoItem_anon = {"": "Closure;newToDo_0",
  call$1: function(e) {
    return this.newToDo_0.remove$0();
  }
};
...
$.IterableMixinWorkaround_removeAllList = function(collection, elementsToRemove) {
  $.removeMatching(collection, $.contains($.CONSTANT3.toSet$0(elementsToRemove)));
};
...
$._HashSetIterator$ = function(set) {
  return new $._HashSetIterator($.CONSTANT3.get$iterator(set._backingMap._keys));
};
...
$.main = function() {
  ...
  $.toDoInput.get$onChange().listen$1($.addToDoItem);
  $.deleteAll = document.query$1("#delete-all");
  $.deleteAll.get$onClick().listen$1(new $.main_anon());
};

$.addToDoItem = function(e) {
  var newToDo = document.$$dom_createElement$1("li");
  newToDo.set$text($.toDoInput.get$value());
  newToDo.get$onClick().listen$1(new $.addToDoItem_anon(newToDo));
  $.toDoInput.set$value("");
  $.add($.toDoList.get$children(), newToDo);
};
...
$.CONSTANT1 = new Isolate.$isolateProperties.EventStreamProvider("change");
