...
$$.FilteredElementList = {"": "Object;_node,_childNodes",
  ...
  remove$1: function(element) {
    ...
    if (!(typeof element === "object" && element !== null && element.$isElement()))
      return;
    for (t1 = $.getInterceptor$JSStringJSArray(this), i = 0; $.CONSTANT3.$lt(i, t1.get$length(this)); ++i) {
...
$.addToDoItem = function(e) {
  var newToDo, t1;
  newToDo = document.$$dom_createElement$1("li");
  t1 = $.toDoInput;
...
$.CONSTANT0 = new Isolate.$isolateProperties.EventStreamProvider("change");
