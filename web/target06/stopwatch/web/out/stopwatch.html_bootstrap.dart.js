...
$.updateTime = function() {
  ...
  s = $.tdiv($.get$mywatch().get$elapsedMilliseconds(), 1000);
  if ($.geB(s, 60)) {
    m = $.tdiv(s, 60);
    s = $.mod(s, 60);
  } else
...
$.init_autogenerated = function() {
  var t1, _root, __stopwatch, __e1, __stoppers1, t2, __startbutton, __stopbutton, __resetbutton, __listener__startbutton_click_2, __listener__stopbutton_click_3, __listener__resetbutton_click_4;
  t1 = {};
  ...
  t2 = __e1.get$nodes();
  $.getInterceptor$JSArray(t2).add$1(t2, $.Text_Text("\n      "));
  __startbutton = __stopwatch.query$1("#startbutton");
  __stopbutton = __stopwatch.query$1("#stopbutton");
  __resetbutton = __stopwatch.query$1("#resetbutton");
  __stoppers1.push($.watchAndInvoke(new $.init_autogenerated_anon(), new $.init_autogenerated_anon0(t1), null));
  __listener__startbutton_click_2 = new $.init_autogenerated_anon1();
  t2 = __startbutton.get$on().get$click();
  $.getInterceptor$JSArray(t2).add$1(t2, __listener__startbutton_click_2);
  __listener__stopbutton_click_3 = new $.init_autogenerated_anon2();
  t2 = __stopbutton.get$on().get$click();
  $.getInterceptor$JSArray(t2).add$1(t2, __listener__stopbutton_click_3);
  __listener__resetbutton_click_4 = new $.init_autogenerated_anon3();
  t2 = __resetbutton.get$on().get$click();
  $.getInterceptor$JSArray(t2).add$1(t2, __listener__resetbutton_click_4);
};
...
(function() {
  ...
  $.dynamicSetMetadata([['Uint8Array', 'Uint8Array|Uint8ClampedArray'], ['HTMLMediaElement', v0_MediaElement], ['SVGElement', v1_SvgElement], ['Element', v3_Element], ['Text', v2_Text], ['CharacterData', v4_CharacterData], ['Document', v5_Document], ['DocumentFragment', v6_DocumentFragment], ['Node', v7_Node], ['EventTarget', [v7_Node, 'EventTarget|DOMWindow'].join('|')], ['NodeList', 'NodeList|RadioNodeList'], ['HTMLCollection', 'HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection']]);
})();
